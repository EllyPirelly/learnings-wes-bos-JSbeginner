...
newImage.src = `https://source.unsplash.com/random/150x150`;
...
// console.log(newUl); // there's no reference to the actual HTML element yet!
...
/* or BUT beware if people change the HTML, this breaks!
const myDiv = newDiv.firstElementChild; */
...
function generatePlayerCard(name, age, height) {
    const html = `
        <div class="playerCard">
            <h2>${name} - ${age}</h2>
            <p>Their height ${height} and their age is ${age} years. In dog years they would be ${age * 7}.</p>
...
/* or
cards.insertAdjacentHTML('afterbegin', generatePlayerCard('billy', 12, 120));
cards.insertAdjacentHTML('afterbegin', generatePlayerCard('bobby', 10, 80));
cards.insertAdjacentHTML('afterbegin', generatePlayerCard('timmy', 8, 180));
cards.insertAdjacentHTML('afterbegin', generatePlayerCard('tommy', 11, 150));
console.log(cardsHTML); */
...
/* add button to the HTML, generated in the function */
