...
var faceDetector = new window.FaceDetector(); // input controls (for pixel amount and scaling of reput image)
...
function censor(_ref) {
  ...
  face.y, face.width, // width and height from source pull (the square)
  face.height, // 4 draw arguments
  face.x, // where should we start drawing
  face.y, options.SIZE, // small image width
  options.SIZE // small image height
  ); // draw the small face back on, but scale up

  var width = face.width * options.SCALE;
  var height = face.height * options.SCALE;
  faceCtx.drawImage(faceCanvas, // source from itself
  face.x, face.y, options.SIZE, options.SIZE, // drawing arguments
  face.x - (width - face.height) / 2, face.y - (height - face.height) / 2, width, height);
}

populateVideo().then(detect);
},{"regenerator-runtime":"node_modules/regenerator-runtime/runtime.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/module-10-01-face-detection.e31bb0bc.js.map